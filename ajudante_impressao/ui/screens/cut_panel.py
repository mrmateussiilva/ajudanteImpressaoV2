...
from ...services.cut_panel import (
    CutBatchRequest,
    CutManualRequest,
    image_dimensions_cm,
    resolve_dpi,
...
class CutPanelWidget(QWidget, ScreenScaffold):
    def __init__(self):
        super().__init__()
    ...
    def _build_sidebar(self) -> QWidget:
        ...
        layout.addWidget(self.build_sidebar_header("PAINEL CUT", "Corte de paineis com gabarito e largura de placa"))

        layout.addWidget(self.section_label("IMPORTACAO"))
        ...
        self.measure_input = self.add_field_card("Largura da placa", "150", "cm", field_grid, 0, 0)
        self.dpi_input = self.add_field_card("DPI manual", "", "opcional", field_grid, 0, 1)
    ...
    def _build_batch_tab(self) -> QWidget:
        ...
        layout = QVBoxLayout(widget)
        layout.setContentsMargins(0, 0, 0, 0)
        self.batch_log = self.build_log_output()
