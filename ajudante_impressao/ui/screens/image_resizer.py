...
from ...algorithms.image_resize import process_resize_folder
...
class ImageResizerWidget(QWidget, ScreenScaffold):
    def __init__(self):
        super().__init__()
    ...
    def _build_sidebar(self) -> QWidget:
        ...
        layout.addWidget(self.build_sidebar_header("REDIMENSIONAR", "Reduz ou amplia em lote mantendo a proporcao"))
        ...
        mode_label = self.field_label("Modo de redimensionamento")
        ...
        self.value_input = self.add_field_card("Valor alvo", "25", "%", field_grid, 0, 0, "_value_field_label")
        self.output_input = self.add_field_card("Subpasta de saida", "REDIMENSIONADAS", "", field_grid, 0, 1)
        config_layout.addLayout(field_grid)

        config_layout.addWidget(self.field_label("Destino"))
